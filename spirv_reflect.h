...
typedef enum SpvReflectShaderStageFlagBits {
  ...
  SPV_REFLECT_SHADER_STAGE_TASK_BIT_NV                 = 0x00004000, // = VK_SHADER_STAGE_TASK_BIT_NV
  SPV_REFLECT_SHADER_STAGE_MESH_BIT_NV                 = 0x00008000, // = VK_SHADER_STAGE_MESH_BIT_NV
